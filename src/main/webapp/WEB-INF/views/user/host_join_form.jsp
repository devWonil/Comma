		...
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<form action="/auth/hostJoinProc" method="post" class="needs-validation"
					...
					<div class="row">
						<div class="col-md-6 mb-3">
							<label for="name">Password Repeat</label> <input type="password"
								class="form-control" id="passwordRepeat" name="passwordRepeat" required>
						...
						let validation = Array.prototype.filter.call(forms,
								function(form) {
									form.addEventListener('submit', function(
										...
										if($('.password_input') !=== $('.passwordRepeat_input')){
