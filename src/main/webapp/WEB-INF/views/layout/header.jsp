        ...
        <div class="container d-flex align-items-center">
          ...
          <div class="site-nav-ul-wrap text-center d-none d-lg-block">
            <ul class="site-nav-ul js-clone-nav">
              ...
              <li class="has-children float-right">
                <a><span class="icon-user-circle"></span>User</a>
                <ul class="dropdown">
                  <c:choose>
...
<body>
	<input id="isNaviFocus" type="hidden" value=0 />
	<!-- Navigation -->
	<nav class="navbar navbar-expand-sm navbar-dark fiexed-top">
		<div id="naviBar" class="container fixed-top"
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				...
				<ul class="navbar-nav ml-auto" style="color: #5a5a5a;">

					<li class="nav-item" style="margin-right: 10px;"><a
						class="nav-link" href="/" style="color: #5a5a5a;"><span
							class="icon-home2"></span>&nbsp;&nbsp;Home</a></li>

					<li class="nav-item"><a class="nav-link" href="/house/list"
						style="color: #5a5a5a;"><span class="icon-list-alt"></span>&nbsp;&nbsp;ssss</a>
					</li>

					<li id="user-content" class="nav-item"
						style="position: relative; left: 700px;"><a
						class="btn nav-link" style="color: #5a5a5a;"><i
